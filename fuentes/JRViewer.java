...
public class JRViewer extends javax.swing.JPanel implements JRHyperlinkListener
{
	...
	private void initComponents() {
		...
		// isSelected para ver si esta seleccionada
		cbAutoClose.setText("Autocierre");
		boolean varEstado = leeEstado();
		cbAutoClose.setSelected( varEstado);
                tlbToolBar.add(cbAutoClose);
		//<--
	...
	*/
	...
	protected javax.swing.JCheckBox cbAutoClose;
	//-->
